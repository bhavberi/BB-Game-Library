...
public class SP_Scores extends JFrame {
    ...
    void initComponents() {
        ...
        setTitle("Space Piano Scores");
        Container contentPane = getContentPane();

        l2.setText("Your Scores are : ");
        l1.setText(Main_SpacePiano.l1);
        l3.setText(Main_SpacePiano.l3);
        t1.setText(Main_SpacePiano.t1);
        t2.setText(Main_SpacePiano.t2);
